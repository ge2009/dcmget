...
# Layout 2 removed the WinSW service payload. Layout 3 added DcmGetCLI.exe to
# the GUI tree. Layout 4 removes it again because CLI is now a separate product.
UPDATE_LAYOUT_VERSION = 4
